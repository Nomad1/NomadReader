...
public class ArabicReshaper{
	 ...
	 * @return
	 */
	private static boolean isHaraka(char target) {
	...
	private static String replaceLamAlef(String unshapedWord) {
	...
	public static String process(String unshapedWord) {
		unshapedWord = replaceLamAlef(unshapedWord);
		DecomposedWord decomposedWord = new DecomposedWord(unshapedWord);
		if (decomposedWord.stripedRegularLetters.length > 0) {
			return reshapeIt(new String(decomposedWord.stripedRegularLetters));
		}
		return unshapedWord;
	}
	 ...
	 */
	public static String reshapeIt(String unshapedWord){
